          ...
          <div class="flex justify-center flex-wrap m-4">
            {Object.keys(products).length === 0 && (
              <p className="flex justify-center text-center text-red-600 mt-20 text-2xl font-bold font-mono">
                Sorry! All Mugs are currently out of stock.
            ...
            {Object.keys(products).map((item) => {
              return (
                ...
                >
                  <div class="lg:w-2/5  md:w-3/4 p-4 w-full cursor-pointer shadow-lg m-3">
...
export async function getServerSideProps(context) {
  ...
  let products = await Product.find({ catagory: "Mugs" });
  let mugs = {};
